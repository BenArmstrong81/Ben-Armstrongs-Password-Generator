...
// **DONE displays within text box** THEN the password is either displayed in an alert or written to the page
// **DONE** Ben: also comments for each section within code.
